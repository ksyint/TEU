import numpy as np
import torch
from rlhf.pipeline import create_validation_pipeline, run_validation


def log_validation(cfg, accelerator, vae, unet, weight_dtype, global_step):
    model_cfg = cfg["model"]
